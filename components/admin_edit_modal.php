    ...
    <div class="modal-content admin-modal-card admin-modal-lg">
        ...
        <div class="modal-body">
            <div id="cancellation-info"
                style="display: none; margin-bottom: 1rem; padding: 0.75rem; background: #fef2f2; border-left: 3px solid var(--danger); border-radius: 4px;">
                <p id="closed-status-title" style="margin: 0 0 0.5rem 0; color: var(--danger); font-weight: 600;">
            ...
            <p id="admin-manage-lock-note"
                style="display:none; margin: 0 0 1rem 0; padding: 0.65rem 0.75rem; background: #fff7ed; border-left: 3px solid #f97316; border-radius: 4px; color: #9a3412; font-size: 0.85rem;">
            ...
            <form id="admin-app-form">
                ...
                <div class="admin-modal-footer">
                    <button type="button" class="btn btn-primary" style="flex: 1;" onclick="saveAdminAppointment()">Save
                        Changes</button>
                </div>
            </form>
        </div>
